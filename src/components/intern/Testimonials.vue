    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <p class="g-color-white" style="text-align:justify;">
                    ...
                    <template>
                      <div style="text-align:right;">- Fahad Ashraf, 2017/2018 Intern</div>
                    </template>
                  </p>
                </div>
              </div>
              <div class="row" style="margin-top:75px;">
                <div class="col-md-10">
                  <p class="g-color-white" style="text-align:justify;">
                    ...
                    <template>
                      <div style="text-align:right;">- Jacob Boisseau, 2017/2018 Intern</div>
                    </template>
                  </p>
                </div>
        ...
        <div class="carousel-item" data-interval="10000">
          <div class="container text-center g-max-width-750 g-mb-20 g-pt-10" alt="Second slide">
            <div class="container">
              <div class="row">
                <div class="col-md-2" style="text-align:center">
                  <img
                ...
                <div class="col-md-10">
                  <p class="g-color-white" style="text-align:justify">
                    ...
                    <template>
                      <div style="text-align:right;">- Andrew Cooper, 2018 Intern</div>
                    </template>
                  </p>
                </div>
              </div>
              <div class="row" style="margin-top:75px;">
                <div class="col-md-10">
                  <p class="g-color-white" style="text-align:justify">
                    ...
                    <template>
                      <div style="text-align:right;">- Sam Peake, 2018 Intern</div>
                    </template>
                  </p>
                </div>
                <div class="col-md-2 order-md-2" style="text-align:center">
        ...
        <div class="carousel-item">
          <div class="container text-center g-max-width-750 g-mb-20 g-pt-10" alt="Third slide">
            <div class="container">
              <div class="row">
                <div class="col-md-2" style="text-align:center">
                  <img
